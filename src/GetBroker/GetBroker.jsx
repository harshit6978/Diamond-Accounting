...
const GetBroker = () => {
    ...
    const getbroker = () => {
        axios.get('https://diamond-be.onrender.com/api/v1/broker/get-brokers').then((res) => {
            console.log(res.data.data, "helo")
                                        ...
                                        broker.map((val) => {
                                            ...
                                            return (
                                                <>
                                                    ...
                                                    <tr>
                                                        <td class="px-2 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-neutral-500">{val.name}</td>
                                                        <td class="px-2 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-500">{val.mobile_no}</td>
